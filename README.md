...
`OpenStoriesFeed` is an extended version of [`JSONFeed`](https://jsonfeed.org), which aims to standardize a feed format built speficially for a type of media similar to an Instagram story.
